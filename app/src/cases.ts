  ...
  vsegazin: {
    ...
    build: [
      ...
      },
      {
        ...
        d: 'Собрали годовую стратегию: цели, анализ рынка и покупательского поведения, портрет аудитории и проработку воронки — от знания бренда до повторных покупок. К ней — маркетинговый календарь, распределение бюджета по каналам и финансовая модель с точкой безубыточности. Тактика росла из плана, а не наоборот.',
      },
      {
        t: 'Перфоманс-маркетинг и веб-аналитика',
        d: 'Запуски в Яндекс Директе и ВК, работа с CPA-сетями и другими площадками, закупка трафика в YouTube-шоу. Настроили веб-аналитику и сквозной учёт, чтобы решения принимались по данным, — и довели ДРР до значений ниже 100%: перфоманс-канал перестал быть статьёй расходов и начал возвращать вложенное.',
      },
      {
      ...
      },
      {
        ...
        d: 'Выстроили автоматические цепочки по базе: сценарии писем и СМС под события — от регистрации и первой покупки до брошенной корзины и возврата из оттока. Отдельно проработали tone of voice и шаблоны, чтобы письма звучали как бренд, а не как системная рассылка.',
      },
      {
    ...
    highlights: [
      ...
      {
        t: 'Стратегия с P&L, а не презентация',
        d: 'Маркетинговый план был посчитан: юнит-экономика по каналам, финансовая модель на горизонт года и рассчитанная точка безубыточности. Это давало не список активностей, а понимание, когда направление выходит в плюс и за счёт чего именно.',
      },
      {
