  ...
  vsegazin: {
    ...
    shift: {
      ...
      rows: [
        ...
        { from: 'Учётный контур на 1С', to: '11 систем в одной связке с обменом в обе стороны' },
        { from: 'Ассортимент под оптовые поставки', to: '545 SKU собственной марки, посчитанных под онлайн' },
        { from: 'Один канал сбыта', to: 'Сайт, мобильное приложение, маркетплейсы и розница' },
    ...
    build: [
      ...
      },
      {
        ...
        d: 'Вместе с товарными направлениями собирали матрицу собственной марки — от образцов и упаковки до производства и логистики. Каждый новый товар проверяли на юнит-экономику в онлайн-канале: габариты, доставку, маржинальность и цену полки. Часть позиций отбирали вместе с Павлом и Ляйсан: амбассадоры участвовали в самом продукте.',
      },
      {
      ...
      },
      {
        ...
        kind: 'курировали и выстроили процесс',
